...
class RegisterMeasurements extends Component {
    ...
    render() {
        const activeTabStyle = {borderBottomWidth: 6, borderColor: '#ff420f'};
        return (
            <View style={{flex: 1}}>
                {this.topBarView()}
                    ...
                    ? (
                        <View style={[styles.topBar, {justifyContent: 'center', paddingHorizontal: 0}]}>
                            <TouchableOpacity style={[styles.tab, this.state.section === 0 && activeTabStyle]}
                                ...
                                <Text style={{fontSize: 14, color: '#FFFFFF'}}>DISP. EMPAREJADOS</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.tab, this.state.section === 1 && activeTabStyle]}
                                              onPress={() => this.setState({section: 1})}>
                                <Text style={{fontSize: 14, color: '#FFFFFF'}}>DISP. NO EMPAREJADOS</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}
                ...
                <View style={{alignSelf: 'flex-end', height: 52}}>
                    <ScrollView
                        ...
                        {Platform.OS === 'android' && this.state.connected
                            ? (
                                <Button
            ...
            {Platform.OS === 'android'
                ? (
                    <View style={styles.enableInfoWrapper}>
                        ...
                        <Switch tintColor='#FFFFFF'
                                onTintColor='#ff420f'
                                thumbTintColor='#ff420f'
